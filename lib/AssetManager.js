...
AssetManager.prototype.createAssetGroup = function(name, assetGroupInfo) {
    ...
    assetGroupInfo.process = assetGroupInfo.process !== undefined ? assetGroupInfo.process : this.options.process;
    assetGroupInfo.files = util.deGlobFiles(assetGroupInfo.files || [], assetGroupInfo.srcDir);
